...
* [On the fly NVS](https://github.com/graphdeco-inria/on-the-fly-nvs?tab=readme-ov-file) : Développée par l'INRIA, cette approche propose d'entraîner les gaussiennes en temps réel. C'est la piste la plus prometteuse pour le projet, car elle permettrait une reconstruction dynamique et fluide durant le vol.
